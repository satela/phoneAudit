...
package {
	...
	public class GameConfig {
		...
		public static var startScene:* = "viewpage/MainPage.scene";
		...
		public static function init():void {
			...
			reg("util.PopUpWindowControl",PopUpWindowControl);
			reg("script.groupAudit.GroupAuditControl",GroupAuditControl);
			reg("script.MainPageControl",MainPageControl);
			reg("util.PictureCheckControl",PictureCheckControl);
		}
		GameConfig.init();
	}
}